...
void pass_fail (bool pass, int test_num, int progress[]) {
  ...
  //===================================================
  // Tests 1-4 Push, dequeue, and first tests
  //===================================================

  // Test 1: 	dequeueing an element from an empty queue.
void test1(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test2(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test3(int progress[], size_t elem_size, value_type elements[]) {
  	bool pass = true;
...
void test4(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test5(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test6(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test7(int progress[], size_t elem_size, value_type elements[]) {
  	bool pass = true;
...
void test8(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test9(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test10(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test11(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test12(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test13(int progress[], size_t elem_size, value_type elements[]) {
  	bool pass = true;
...
void test14(int progress[], size_t elem_size, value_type elements[]) {
  	bool pass = true;
...
void test15(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test16(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test17(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test18(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test19(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
void test20(int progress[], size_t elem_size, value_type elements[]) {
	bool pass = true;
...
main (int argc, char *argv[])
{
  ...
  //					BEGIN TESTING
	...
	test1(int progress[], size_t elem_size, value_type elements[]);
	test2(int progress[], size_t elem_size, value_type elements[]);
	test3(int progress[], size_t elem_size, value_type elements[]);
	test4(int progress[], size_t elem_size, value_type elements[]);
	test5(int progress[], size_t elem_size, value_type elements[]);
	test6(int progress[], size_t elem_size, value_type elements[]);
	test7(int progress[], size_t elem_size, value_type elements[]);
	test8(int progress[], size_t elem_size, value_type elements[]);
	test9(int progress[], size_t elem_size, value_type elements[]);
	test10(int progress[], size_t elem_size, value_type elements[]);
	test11(int progress[], size_t elem_size, value_type elements[]);
	test12(int progress[], size_t elem_size, value_type elements[]);
	test13(int progress[], size_t elem_size, value_type elements[]);
	test14(int progress[], size_t elem_size, value_type elements[]);
	test15(int progress[], size_t elem_size, value_type elements[]);
	test16(int progress[], size_t elem_size, value_type elements[]);
	test17(int progress[], size_t elem_size, value_type elements[]);
	test18(int progress[], size_t elem_size, value_type elements[]);
	test19(int progress[], size_t elem_size, value_type elements[]);
	test20(int progress[], size_t elem_size, value_type elements[]);
